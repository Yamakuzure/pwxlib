...
#include <PDoubleList>
#include <PDoubleRing>
typedef PSingleList<keydata_t> single_list_t;
typedef PSingleRing<keydata_t> single_ring_t;
typedef PDoubleList<keydata_t> double_list_t;
typedef PDoubleRing<keydata_t> double_ring_t;
