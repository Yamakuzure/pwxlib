...
// Automatically generated Header! Do NOT modify! See bottom of this file for more information

#ifndef PWX_RANDOM_WORD_CONSTANTS_H
#define PWX_RANDOM_WORD_CONSTANTS_H

#ifndef PWX_RANDOM_H_INCLUDED
# error "Don't include CRandomWordConstants.h directly! Include CRandom.h instead!"
#endif

/** @internal
  * @file CRandomWordConstants.h
  *
  * @brief Auto-Generated Header file with rules for name generation
  *
  @verbatim
  ...
  * -- ( ==>       3083 E-Mail adresses have been filtered out)              -- *
  * -- ( ==>       5187 Internet adresses have been filtered out)            -- *
  * -- ( ==>         23 Tripple Threats have been filtered out)              -- *
...
const int32_t genCharMask    = 0x3ffffff; //!< A mask to filter the the position out of the FUM
const int32_t genStartAllow  = 0x04000000; //!< A 2-char-combination is allowed to start a par
...
} // end namespace NameConstants

} // End of namespace rng

} // End of namespace pwx

#endif // PWX_RANDOM_WORD_CONSTANTS_H
...
/** @internal
  ...
  * got recorded.                                 *
  * Sequences with very little occurances are     *
  * filtered out, as they might indicate typos.   *
  * All character occurances are recorded as well,*
  * and the resulting consonant and vowel strings *
  * have then been generated by randomly mixing   *
  * those characters randomly. Due to this mixing *
  * the program will produce different strings    *
  * every time it is called, even with the same   *
  * text files!                                   *
  * --------------------------------------------- *
  * Q: Why are all those constants mixed case?    *
  *    They should be all upparcase!              *
  ...
  * --------------------------------------------- *
  * textAnalyzer - (c) Sven Eden, PrydeWorX 2010  *
  @endverbatim
**/
